...
comprise them, neither can anyone produce prodcucts of higher quality than the
average quality of the parts therein, and seldom produced are products of
better quality than the least quality of all the parts therein, of such are the
laws of creation;
...
unto forfeiting my life as forfiet and moving on to the next one as often as is
nessicessary.  For a life fettered by chains is worse no life at all.*
...
***SIC MVNDVS CREATVS EST!***  Thus was this world, --- even this project to
create an acceptable build system for myself, my own use, --- was created!
...
## Parts
This project consists of two parts: the build system itself,"Spellbinder",
...
This software, --- it's documentation, it's binary and non-binary output files,
